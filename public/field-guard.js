(()=>{
 ...
 globalThis.__fishwizzTest=Object.assign(globalThis.__fishwizzTest||{},{fieldGuard:{isEmailShaped,rejectIfEmailShaped}});
 if(typeof window==='undefined')return; // testable in plain Node up to here; nothing below touches fishing fields
 window.FishWizzGuard={isEmailShaped,rejectIfEmailShaped};
